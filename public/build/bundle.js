...
var app = (function () {
    ...
    const file$7 = "src/Colors.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "title-section");
    			add_location(span0, file$6, 6, 12, 152);
    			attr_dev(div0, "class", "style-guide__fonts__primary__title");
    			add_location(div0, file$6, 8, 16, 263);
    			attr_dev(div1, "class", "style-guide__fonts__primary__desc");
    			add_location(div1, file$6, 11, 16, 384);
    			add_location(span1, file$6, 16, 24, 667);
    			add_location(span2, file$6, 19, 24, 766);
    			attr_dev(div2, "class", "style-guide__fonts__primary__body-text__paragraph regular");
    			add_location(div2, file$6, 15, 20, 571);
    			attr_dev(div3, "class", "style-guide__fonts__primary__body-text");
    			add_location(div3, file$6, 14, 16, 498);
    			add_location(span3, file$6, 26, 24, 1226);
    			add_location(span4, file$6, 29, 24, 1322);
    			attr_dev(div4, "class", "style-guide__fonts__primary__body-text__paragraph bold");
    			add_location(div4, file$6, 25, 20, 1133);
    			attr_dev(div5, "class", "style-guide__fonts__primary__body-text");
    			add_location(div5, file$6, 24, 16, 1060);
    			add_location(span5, file$6, 36, 24, 1787);
    			add_location(span6, file$6, 39, 24, 1888);
    			attr_dev(div6, "class", "style-guide__fonts__primary__body-text__paragraph extrabold");
    			add_location(div6, file$6, 35, 20, 1689);
    			attr_dev(div7, "class", "style-guide__fonts__primary__body-text");
    			add_location(div7, file$6, 34, 16, 1616);
    			attr_dev(div8, "class", "style-guide__fonts__primary");
    			add_location(div8, file$6, 7, 12, 205);
    			attr_dev(div9, "class", "style-guide__fonts__secondary__title");
    			add_location(div9, file$6, 46, 16, 2257);
    			attr_dev(div10, "class", "style-guide__fonts__secondary__desc");
    			add_location(div10, file$6, 49, 16, 2380);
    			add_location(span7, file$6, 54, 24, 2664);
    			add_location(span8, file$6, 57, 24, 2763);
    			attr_dev(div11, "class", "style-guide__fonts__primary__body-text__paragraph regular");
    			add_location(div11, file$6, 53, 20, 2568);
    			attr_dev(div12, "class", "style-guide__fonts__primary__body-text");
    			add_location(div12, file$6, 52, 16, 2495);
    			add_location(span9, file$6, 64, 24, 3223);
    			add_location(span10, file$6, 67, 24, 3319);
    			attr_dev(div13, "class", "style-guide__fonts__primary__body-text__paragraph bold");
    			add_location(div13, file$6, 63, 20, 3130);
    			attr_dev(div14, "class", "style-guide__fonts__primary__body-text");
    			add_location(div14, file$6, 62, 16, 3057);
    			add_location(span11, file$6, 74, 24, 3784);
    			add_location(span12, file$6, 77, 24, 3885);
    			attr_dev(div15, "class", "style-guide__fonts__primary__body-text__paragraph extrabold");
    			add_location(div15, file$6, 73, 20, 3686);
    			attr_dev(div16, "class", "style-guide__fonts__primary__body-text");
    			add_location(div16, file$6, 72, 16, 3613);
    			attr_dev(div17, "class", "style-guide__fonts__secondary");
    			add_location(div17, file$6, 45, 12, 2197);
    			add_location(h1, file$6, 84, 16, 4254);
    			add_location(h2, file$6, 85, 16, 4301);
    			add_location(h3, file$6, 86, 16, 4354);
    			add_location(h4, file$6, 87, 16, 4407);
    			add_location(h5, file$6, 88, 16, 4460);
    			add_location(h6, file$6, 89, 16, 4513);
    			attr_dev(div18, "class", "style-guide__fonts__headlines");
    			add_location(div18, file$6, 83, 12, 4194);
    			attr_dev(div19, "class", "style-guide__fonts__container");
    			add_location(div19, file$6, 5, 8, 96);
    			attr_dev(div20, "class", "style-guide__fonts");
    			add_location(div20, file$6, 4, 4, 55);
    			attr_dev(div21, "class", "style-guide__row");
    			add_location(div21, file$6, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src/Buttons.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i11 = element("i");
    			attr_dev(span0, "class", "title-section");
    			add_location(span0, file$5, 7, 16, 258);
    			attr_dev(button0, "class", "jca-button");
    			attr_dev(button0, "type", "button");
    			add_location(button0, file$5, 10, 24, 432);
    			attr_dev(div0, "class", "m-lg");
    			add_location(div0, file$5, 9, 20, 389);
    			attr_dev(button1, "class", "jca-button active");
    			attr_dev(button1, "type", "button");
    			add_location(button1, file$5, 15, 24, 634);
    			attr_dev(div1, "class", "m-lg");
    			add_location(div1, file$5, 14, 20, 591);
    			attr_dev(button2, "class", "jca-button disabled");
    			attr_dev(button2, "type", "button");
    			add_location(button2, file$5, 20, 24, 842);
    			attr_dev(div2, "class", "m-lg");
    			add_location(div2, file$5, 19, 20, 799);
    			attr_dev(button3, "class", "jca-button secondary");
    			attr_dev(button3, "type", "button");
    			add_location(button3, file$5, 25, 24, 1054);
    			attr_dev(div3, "class", "m-lg");
    			add_location(div3, file$5, 24, 20, 1011);
    			attr_dev(button4, "class", "jca-button medium");
    			attr_dev(button4, "type", "button");
    			add_location(button4, file$5, 30, 24, 1268);
    			attr_dev(button5, "class", "jca-button small");
    			attr_dev(button5, "type", "button");
    			add_location(button5, file$5, 33, 24, 1410);
    			attr_dev(div4, "class", "m-lg");
    			add_location(div4, file$5, 29, 20, 1225);
    			attr_dev(div5, "class", "style-guide__buttons__left__container");
    			add_location(div5, file$5, 8, 16, 317);
    			attr_dev(div6, "class", "style-guide__buttons__left border-right");
    			add_location(div6, file$5, 6, 12, 188);
    			attr_dev(span1, "class", "title-section");
    			add_location(span1, file$5, 42, 16, 1744);
    			add_location(br, file$5, 44, 20, 1881);
    			attr_dev(i0, "class", "fa fa-instagram");
    			add_location(i0, file$5, 49, 33, 2064);
    			attr_dev(a0, "href", "https://www.instagram.com/");
    			add_location(a0, file$5, 48, 28, 1994);
    			add_location(li0, file$5, 47, 24, 1961);
    			attr_dev(i1, "class", "fa fa-twitter");
    			add_location(i1, file$5, 54, 33, 2278);
    			attr_dev(a1, "href", "https://twitter.com/");
    			add_location(a1, file$5, 53, 28, 2214);
    			add_location(li1, file$5, 52, 24, 2181);
    			attr_dev(i2, "class", "fa fa-linkedin");
    			add_location(i2, file$5, 59, 33, 2495);
    			attr_dev(a2, "href", "https://www.linkedin.com/");
    			add_location(a2, file$5, 58, 28, 2426);
    			add_location(li2, file$5, 57, 24, 2393);
    			attr_dev(i3, "class", "fa fa-github");
    			add_location(i3, file$5, 64, 33, 2707);
    			attr_dev(a3, "href", "https://github.com/");
    			add_location(a3, file$5, 63, 28, 2644);
    			add_location(li3, file$5, 62, 24, 2611);
    			attr_dev(ul0, "class", "jca-social-icons");
    			add_location(ul0, file$5, 46, 20, 1907);
    			attr_dev(i4, "class", "fa fa-instagram");
    			add_location(i4, file$5, 71, 33, 3013);
    			attr_dev(a4, "href", "https://www.instagram.com/");
    			add_location(a4, file$5, 70, 28, 2943);
    			add_location(li4, file$5, 69, 24, 2910);
    			attr_dev(i5, "class", "fa fa-twitter");
    			add_location(i5, file$5, 76, 33, 3227);
    			attr_dev(a5, "href", "https://twitter.com/");
    			add_location(a5, file$5, 75, 28, 3163);
    			add_location(li5, file$5, 74, 24, 3130);
    			attr_dev(i6, "class", "fa fa-linkedin");
    			add_location(i6, file$5, 81, 33, 3444);
    			attr_dev(a6, "href", "https://www.linkedin.com/");
    			add_location(a6, file$5, 80, 28, 3375);
    			add_location(li6, file$5, 79, 24, 3342);
    			attr_dev(i7, "class", "fa fa-github");
    			add_location(i7, file$5, 86, 33, 3656);
    			attr_dev(a7, "href", "https://github.com/");
    			add_location(a7, file$5, 85, 28, 3593);
    			add_location(li7, file$5, 84, 24, 3560);
    			attr_dev(ul1, "class", "jca-social-icons medium-icons");
    			add_location(ul1, file$5, 68, 20, 2843);
    			attr_dev(i8, "class", "fa fa-instagram");
    			add_location(i8, file$5, 93, 33, 3961);
    			attr_dev(a8, "href", "https://www.instagram.com/");
    			add_location(a8, file$5, 92, 28, 3891);
    			add_location(li8, file$5, 91, 24, 3858);
    			attr_dev(i9, "class", "fa fa-twitter");
    			add_location(i9, file$5, 98, 33, 4175);
    			attr_dev(a9, "href", "https://twitter.com/");
    			add_location(a9, file$5, 97, 28, 4111);
    			add_location(li9, file$5, 96, 24, 4078);
    			attr_dev(i10, "class", "fa fa-linkedin");
    			add_location(i10, file$5, 103, 33, 4392);
    			attr_dev(a10, "href", "https://www.linkedin.com/");
    			add_location(a10, file$5, 102, 28, 4323);
    			add_location(li10, file$5, 101, 24, 4290);
    			attr_dev(i11, "class", "fa fa-github");
    			add_location(i11, file$5, 108, 33, 4604);
    			attr_dev(a11, "href", "https://github.com/");
    			add_location(a11, file$5, 107, 28, 4541);
    			add_location(li11, file$5, 106, 24, 4508);
    			attr_dev(ul2, "class", "jca-social-icons small-icons");
    			add_location(ul2, file$5, 90, 20, 3792);
    			attr_dev(div7, "class", "style-guide__buttons__right__container");
    			add_location(div7, file$5, 43, 16, 1808);
    			attr_dev(div8, "class", "style-guide__buttons__right");
    			add_location(div8, file$5, 41, 12, 1686);
    			attr_dev(div9, "class", "style-guide__buttons__container");
    			add_location(div9, file$5, 5, 8, 130);
    			attr_dev(div10, "class", "style-guide__buttons");
    			add_location(div10, file$5, 4, 4, 87);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(code, file$4, 6, 12, 148);
    			attr_dev(div0, "class", "style-guide__CSS__container");
    			add_location(div0, file$4, 5, 8, 94);
    			attr_dev(div1, "class", "style-guide__CSS");
    			add_location(div1, file$4, 4, 4, 55);
    			attr_dev(div2, "class", "style-guide__row");
    			add_location(div2, file$4, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "title-section");
    			add_location(span0, file$3, 6, 12, 153);
    			attr_dev(span1, "class", "year");
    			add_location(span1, file$3, 10, 24, 375);
    			add_location(h40, file$3, 11, 24, 435);
    			add_location(p0, file$3, 12, 24, 496);
    			attr_dev(div0, "class", "jca-timeline__element__inner");
    			add_location(div0, file$3, 9, 20, 308);
    			attr_dev(div1, "class", "jca-timeline__element");
    			add_location(div1, file$3, 8, 16, 252);
    			attr_dev(span2, "class", "year");
    			add_location(span2, file$3, 20, 24, 841);
    			add_location(h41, file$3, 21, 24, 901);
    			add_location(p1, file$3, 22, 24, 961);
    			attr_dev(div2, "class", "jca-timeline__element__inner");
    			add_location(div2, file$3, 19, 20, 774);
    			attr_dev(div3, "class", "jca-timeline__element");
    			add_location(div3, file$3, 18, 16, 718);
    			attr_dev(span3, "class", "year");
    			add_location(span3, file$3, 30, 24, 1306);
    			add_location(h42, file$3, 31, 24, 1366);
    			add_location(p2, file$3, 32, 24, 1414);
    			attr_dev(div4, "class", "jca-timeline__element__inner");
    			add_location(div4, file$3, 29, 20, 1239);
    			attr_dev(div5, "class", "jca-timeline__element");
    			add_location(div5, file$3, 28, 16, 1183);
    			attr_dev(span4, "class", "year");
    			add_location(span4, file$3, 40, 24, 1759);
    			add_location(h43, file$3, 41, 24, 1819);
    			add_location(p3, file$3, 42, 24, 1879);
    			attr_dev(div6, "class", "jca-timeline__element__inner");
    			add_location(div6, file$3, 39, 20, 1692);
    			attr_dev(div7, "class", "jca-timeline__element");
    			add_location(div7, file$3, 38, 16, 1636);
    			attr_dev(div8, "class", "jca-timeline");
    			add_location(div8, file$3, 7, 12, 209);
    			attr_dev(div9, "class", "p-t-lg p-b-lg");
    			add_location(div9, file$3, 5, 8, 113);
    			attr_dev(div10, "class", "style-guide__timeline");
    			add_location(div10, file$3, 4, 4, 69);
    			attr_dev(div11, "class", "style-guide__row border-bottom");
    			add_location(div11, file$3, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "title-section");
    			add_location(span0, file$2, 5, 8, 110);
    			...
    			add_location(img0, file$2, 11, 29, 382);
    			attr_dev(a0, "href", "blog-single.html");
    			add_location(a0, file$2, 10, 24, 326);
    			add_location(span1, file$2, 17, 29, 707);
    			attr_dev(a1, "href", "blog-grid.html");
    			attr_dev(a1, "class", "card__thumb__date");
    			add_location(a1, file$2, 16, 24, 627);
    			attr_dev(div0, "class", "card__thumb");
    			add_location(div0, file$2, 9, 20, 276);
    			attr_dev(a2, "href", "blog-single.html");
    			add_location(a2, file$2, 22, 28, 888);
    			add_location(h40, file$2, 21, 24, 855);
    			add_location(p0, file$2, 26, 24, 1076);
    			attr_dev(a3, "class", "card__content__read-more");
    			attr_dev(a3, "href", "blog-single.html");
    			add_location(a3, file$2, 30, 24, 1296);
    			attr_dev(div1, "class", "card__content");
    			add_location(div1, file$2, 20, 20, 803);
    			attr_dev(div2, "class", "card");
    			add_location(div2, file$2, 8, 16, 237);
    			add_location(div3, file$2, 7, 12, 215);
    			...
    			add_location(img1, file$2, 38, 29, 1629);
    			attr_dev(a4, "href", "blog-single.html");
    			add_location(a4, file$2, 37, 24, 1573);
    			add_location(span2, file$2, 44, 29, 1954);
    			attr_dev(a5, "href", "blog-grid.html");
    			attr_dev(a5, "class", "card__thumb__date");
    			add_location(a5, file$2, 43, 24, 1874);
    			attr_dev(div4, "class", "card__thumb");
    			add_location(div4, file$2, 36, 20, 1523);
    			attr_dev(a6, "href", "blog-single.html");
    			add_location(a6, file$2, 49, 28, 2135);
    			add_location(h41, file$2, 48, 24, 2102);
    			add_location(p1, file$2, 53, 24, 2323);
    			attr_dev(a7, "class", "card__content__read-more");
    			attr_dev(a7, "href", "blog-single.html");
    			add_location(a7, file$2, 57, 24, 2543);
    			attr_dev(div5, "class", "card__content");
    			add_location(div5, file$2, 47, 20, 2050);
    			attr_dev(div6, "class", "card hover-item");
    			add_location(div6, file$2, 35, 16, 1473);
    			add_location(div7, file$2, 34, 12, 1451);
    			...
    			add_location(img2, file$2, 65, 29, 2876);
    			attr_dev(a8, "href", "blog-single.html");
    			add_location(a8, file$2, 64, 24, 2820);
    			add_location(span3, file$2, 71, 29, 3201);
    			attr_dev(a9, "href", "blog-grid.html");
    			attr_dev(a9, "class", "card__thumb__date");
    			add_location(a9, file$2, 70, 24, 3121);
    			attr_dev(div8, "class", "card__thumb");
    			add_location(div8, file$2, 63, 20, 2770);
    			attr_dev(a10, "href", "blog-single.html");
    			add_location(a10, file$2, 76, 28, 3382);
    			add_location(h42, file$2, 75, 24, 3349);
    			add_location(p2, file$2, 80, 24, 3570);
    			attr_dev(a11, "class", "card__content__read-more");
    			attr_dev(a11, "href", "blog-single.html");
    			add_location(a11, file$2, 84, 24, 3790);
    			attr_dev(div9, "class", "card__content");
    			add_location(div9, file$2, 74, 20, 3297);
    			attr_dev(div10, "class", "card hover-item");
    			add_location(div10, file$2, 62, 16, 2720);
    			add_location(div11, file$2, 61, 12, 2698);
    			attr_dev(div12, "class", "style-guide__cards__container");
    			add_location(div12, file$2, 6, 8, 159);
    			attr_dev(div13, "class", "style-guide__cards");
    			add_location(div13, file$2, 4, 4, 69);
    			attr_dev(div14, "class", "style-guide__row border-bottom");
    			add_location(div14, file$2, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/Inputs.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "title-section");
    			add_location(span, file$1, 5, 8, 111);
    			...
    			add_location(input0, file$1, 9, 20, 324);
    			add_location(label0, file$1, 20, 20, 800);
    			attr_dev(div0, "class", "jca-input-text");
    			add_location(div0, file$1, 8, 16, 275);
    			attr_dev(div1, "class", "style-guide__inputs__input");
    			add_location(div1, file$1, 7, 12, 218);
    			...
    			add_location(input1, file$1, 25, 20, 983);
    			add_location(label1, file$1, 37, 20, 1522);
    			attr_dev(div2, "class", "jca-input-text");
    			add_location(div2, file$1, 24, 16, 934);
    			add_location(div3, file$1, 40, 20, 1640);
    			attr_dev(div4, "class", "jca-input-text-bellow");
    			add_location(div4, file$1, 39, 16, 1584);
    			attr_dev(div5, "class", "style-guide__inputs__input");
    			add_location(div5, file$1, 23, 12, 877);
    			...
    			add_location(input2, file$1, 47, 20, 1888);
    			add_location(label2, file$1, 59, 20, 2398);
    			attr_dev(div6, "class", "jca-input-text _disabled");
    			add_location(div6, file$1, 46, 16, 1829);
    			attr_dev(div7, "class", "style-guide__inputs__input");
    			add_location(div7, file$1, 45, 12, 1772);
    			...
    			add_location(input3, file$1, 64, 20, 2594);
    			add_location(label3, file$1, 75, 20, 3076);
    			attr_dev(div8, "class", "jca-input-text _show-error");
    			add_location(div8, file$1, 63, 16, 2533);
    			attr_dev(div9, "class", "style-guide__inputs__input");
    			add_location(div9, file$1, 62, 12, 2476);
    			...
    			add_location(input4, file$1, 80, 20, 3277);
    			add_location(label4, file$1, 91, 20, 3759);
    			attr_dev(div10, "class", "jca-input-text _show-error");
    			add_location(div10, file$1, 79, 16, 3216);
    			add_location(div11, file$1, 94, 20, 3883);
    			attr_dev(div12, "class", "jca-input-text-bellow");
    			add_location(div12, file$1, 93, 16, 3827);
    			attr_dev(div13, "class", "style-guide__inputs__input");
    			add_location(div13, file$1, 78, 12, 3159);
    			attr_dev(div14, "class", "style-guide__inputs__container");
    			add_location(div14, file$1, 6, 8, 161);
    			attr_dev(div15, "class", "style-guide__inputs");
    			add_location(div15, file$1, 4, 4, 69);
    			attr_dev(div16, "class", "style-guide__row border-bottom");
    			add_location(div16, file$1, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file, 12, 1, 334);
