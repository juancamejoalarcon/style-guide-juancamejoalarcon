    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span1, file$1, 16, 24, 667);
    			add_location(span2, file$1, 19, 24, 766);
    			attr_dev(div2, "class", "style-guide__fonts__primary__body-text__paragraph regular");
    			add_location(div2, file$1, 15, 20, 571);
    			attr_dev(div3, "class", "style-guide__fonts__primary__body-text");
    			add_location(div3, file$1, 14, 16, 498);
    			add_location(span3, file$1, 26, 24, 1226);
    			add_location(span4, file$1, 29, 24, 1322);
    			attr_dev(div4, "class", "style-guide__fonts__primary__body-text__paragraph bold");
    			add_location(div4, file$1, 25, 20, 1133);
    			attr_dev(div5, "class", "style-guide__fonts__primary__body-text");
    			add_location(div5, file$1, 24, 16, 1060);
    			add_location(span5, file$1, 36, 24, 1787);
    			add_location(span6, file$1, 39, 24, 1888);
    			attr_dev(div6, "class", "style-guide__fonts__primary__body-text__paragraph extrabold");
    			add_location(div6, file$1, 35, 20, 1689);
    			attr_dev(div7, "class", "style-guide__fonts__primary__body-text");
    			add_location(div7, file$1, 34, 16, 1616);
    			...
    			add_location(div9, file$1, 46, 16, 2257);
    			attr_dev(div10, "class", "style-guide__fonts__secondary__desc");
    			add_location(div10, file$1, 49, 16, 2380);
    			add_location(span7, file$1, 54, 24, 2664);
    			add_location(span8, file$1, 57, 24, 2763);
    			attr_dev(div11, "class", "style-guide__fonts__primary__body-text__paragraph regular");
    			add_location(div11, file$1, 53, 20, 2568);
    			attr_dev(div12, "class", "style-guide__fonts__primary__body-text");
    			add_location(div12, file$1, 52, 16, 2495);
    			add_location(span9, file$1, 64, 24, 3223);
    			add_location(span10, file$1, 67, 24, 3319);
    			attr_dev(div13, "class", "style-guide__fonts__primary__body-text__paragraph bold");
    			add_location(div13, file$1, 63, 20, 3130);
    			attr_dev(div14, "class", "style-guide__fonts__primary__body-text");
    			add_location(div14, file$1, 62, 16, 3057);
    			add_location(span11, file$1, 74, 24, 3784);
    			add_location(span12, file$1, 77, 24, 3885);
    			attr_dev(div15, "class", "style-guide__fonts__primary__body-text__paragraph extrabold");
    			add_location(div15, file$1, 73, 20, 3686);
    			attr_dev(div16, "class", "style-guide__fonts__primary__body-text");
    			add_location(div16, file$1, 72, 16, 3613);
    			attr_dev(div17, "class", "style-guide__fonts__secondary");
    			add_location(div17, file$1, 45, 12, 2197);
    			add_location(h1, file$1, 84, 16, 4254);
    			add_location(h2, file$1, 85, 16, 4291);
    			add_location(h3, file$1, 86, 16, 4328);
    			add_location(h4, file$1, 87, 16, 4365);
    			add_location(h5, file$1, 88, 16, 4402);
    			add_location(h6, file$1, 89, 16, 4439);
    			attr_dev(div18, "class", "style-guide__fonts__headlines");
    			add_location(div18, file$1, 83, 12, 4194);
